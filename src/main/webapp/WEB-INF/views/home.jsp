		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 text-center" id="bg-first">
					...
					<p> 비트코인 정보공유를 위해 제작되었습니다 </p>
					<p> 실시간으로 비트코인의 시세를 볼 수 있습니다 </p>
					<p> 국내외 기사들을 수집할 수 있습니다</p>
	...
	<section class="bg-second">
		<div class="container-fluid text-center">
			...
			<div class="row second-content">
				...
				<div class="col-md-4">
					<a href="/sboard/list"><img alt="서비스소개" src="../../resources/img/bitcoin_light_black_psy_resize.png"></a>
					<h3>비트코인 커뮤니티</h3>
