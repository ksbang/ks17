...
import com.anyang.ks.myPage.ChangePassword;
...
public class UserDAOImpl implements UserDAO{
	...
	private static String namespace = "com.anyang.ks.mapper.UserMapper";
	...
	public String checkEmailDuplication(String email) throws Exception {
		...
		try{
			...
			if (userEmail != null){
				email_state = "0";	//나오면 DB에 존재(0)
			}else{
				email_state = "1"; //안 나오면 DB에 없음(1)
			}
